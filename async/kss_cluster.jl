...
global ercotscens = collect(DataFrame(CSV.File("../../FinalProject/scenarios/cluster_c$(K).csv"))[expid,:])
global probs = collect(DataFrame(CSV.File("../../FinalProject/scenarios/probs$(K).csv"))[expid,:])
