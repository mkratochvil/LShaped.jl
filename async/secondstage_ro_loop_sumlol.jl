...
#before it was _async, but I am changing just to see what happens...
...
if converged == 0
    ...
    let
        ...
        model2 = JuMP.read_from_file("../../FinalProject/sum_lol/sum_lol/second_stage_model_lolsum_scen_1.mps")
